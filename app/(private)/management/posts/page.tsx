                ...
                <div className="flex items-end justify-between gap-4 flex-wrap">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 w-full sm:w-auto">
                        ...
                        <Link
                            ...
                            className="px-4 py-2 rounded bg-[var(--accent-cyan)] text-black font-semibold hover:bg-[var(--accent-pink)] transition inline-flex h-10 items-center justify-center whitespace-nowrap"
                        >
                            ＋ 新規投稿
                        </Link>
                    </div>
