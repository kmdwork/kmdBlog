    ...
    <main className="min-h-screen bg-app text-app font-mono">
      ...
      <section id="contact" className="max-w-7xl mx-auto px-6 py-20">
        <div className="bg-card border border-[var(--border)] rounded-2xl p-10 text-center">
          <h3 className="text-3xl font-black mb-4">LET&apos;S <span className="text-[var(--accent-yellow)]">BUILD</span> SOMETHING</h3>
          <p className="opacity-80 mb-6">相談、共同制作、コードレビューなど、お気軽にどうぞ。</p>
          <Link href="mailto:you@example.com" className="inline-block px-6 py-3 font-bold uppercase border-2 rounded border-[var(--accent-cyan)] text-black bg-[var(--accent-cyan)] hover:bg-[var(--accent-pink)] hover:border-[var(--accent-pink)] transition">[SEND_EMAIL]</Link>
        </div>
      </section>
